...
export default function Cards({
  ...
  return (
    <div
      ...
      border-1 rounded-2xl border-gray-200 cursor-pointer hover:border-2 hover:border-gray-200 dark:hover:bg-gray-800 dark:border-gray-600 dark:hover:shadow-gray-500 dark:hover:shadow-md dark:hover:border dark:hover:border-gray-500"
    >
